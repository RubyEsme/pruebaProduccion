    ...
    <div class="container mt-3">
        ...
        <form action="{{ route('materiales.update', $material->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="codigo_mp" name="codigo_mp" value="{{ $material->codigo_mp }}" required>
            </div>

            <div class="form-group">
                <label for="descripcion_1">Descripción 1:</label>
                <input type="text" class="form-control" id="descripcion_1" name="descripcion_1" value="{{ $material->descripcion_1 }}" required>
            </div>
