...
<body>
  <div class="container mt-5">
    ...
    <form class="form-signin" method="POST" action="{{route('inicia-sesion')}}">
    @csrf
      <div class="form-group">
        <label for="emailInput" class="sr-only">Email</label>
        <input type="email" id="emailInput" name="email" class="form-control" placeholder="Email" required autofocus autocomplete="disable">
      </div>
