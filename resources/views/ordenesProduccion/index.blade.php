...
<body>
    ...
    <div class="container mt-3">
        ...
        <div class="row">
            ...
            <h2>Listado de Órdenes de Producción Pendientes</h2>

            <a href="{{ route('ordenesProduccion.index') }}" class="btn btn-info son">Actualizar</a>   

            <a href="{{ route('ordenesProduccion.index2') }}" class="btn btn-primary son2">Ver Órdenes Surtidas/Cerradas</a>   
            ...
            <tbody>
                ...
                @foreach($ordenesProduccion->unique('noOrden') as $orden)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('ordenesProduccion.show', $orden->id) }}" class="btn btn-success">Seleccionar</a>
                        </td>
                    </tr>
                @endforeach
